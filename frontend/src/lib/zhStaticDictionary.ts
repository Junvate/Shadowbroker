const ZH_STATIC_DICTIONARY: Record<string, string> = {
  ...
  'Oracle Predictions': '预言机预测',
  Trending: '热门',
  Active: '活跃',
  Profile: '档案',
  'Search Markets...': '搜索市场...',
  'Searching all markets...': '正在搜索全部市场...',
  'Results (Polymarket + Kalshi)': '条结果（Polymarket + Kalshi）',
  'No results found for': '未找到',
  'Connect Wormhole or generate an identity in MeshChat first': '请先连接虫洞或在网状通信中生成身份',
  'Online API': '在线接口',
  'Simulation Mode': '模拟模式',
  'Analyzing...': '正在分析中...',
  'AI request failed, please try again later': 'AI 请求失败，请稍后重试',
  'Request failed:': '请求失败：',
  'AI Assistant': 'AI 助手',
  'Parameter Settings': '参数配置',
  'Clear Chat History': '清空聊天记录',
  'Clear History': '清空记录',
  'Runtime Parameters': '运行参数',
  Temperature: '温度',
  'Max Tokens': '最大令牌数',
  'Include History Context': '携带历史上下文',
  'Task Count': '任务数',
  Success: '成功',
  Failure: '失败',
  'Parse Question': '解析问题',
  'Match Skills': '匹配技能',
  'Execute And Summarize': '执行并汇总',
  Complete: '完成',
  Flight: '航班',
  Route: '航线',
  Altitude: '高度',
  ...
  OVERLAYS: '叠加层',
  'Shodan Overlay': 'Shodan 测绘叠加层',
  'Operator Search': '操作员搜索',
  ...
  Position: '位置',
  'Threat Intercept': '威胁拦截',
  'Level:': '等级:',
  'System Status: Monitoring': '系统状态：监控中',
  Scanning: '扫描中',
  'Threat:': '威胁：',
  Breaking: '突发',
